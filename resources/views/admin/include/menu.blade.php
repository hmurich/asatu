<ul class="admin-nav">
    ...
    @elseif (Auth::user() && Auth::user()->type_id == 2)
        ...
        <li class='{{ (Request::is('adminka/restoran*') || Request::is('adminka/menu*') || Request::is('adminka/location*') ? "active" : null) }}'>
        ...
        <li class='{{ (Request::is('adminka/ticket/list*') ? "active" : null) }}'>
            <a href="{{ action('Admin\TicketController@getList') }}">запросы</a>
        </li>
